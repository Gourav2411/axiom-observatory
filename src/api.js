...
export const api = {
  ...
  queueValidationAdmet: (id, input, accessToken) => request(`/api/runs/${encodeURIComponent(id)}/validation/admet`, { method: "POST", body: JSON.stringify(input), accessToken }),
  ...
  uploadReceptor: (id, input, accessToken) => request(`/api/runs/${encodeURIComponent(id)}/receptors`, { method: "POST", body: JSON.stringify(input), accessToken }),
