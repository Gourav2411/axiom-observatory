...
function CampaignPanel({run, accessToken}) {
  ...
  return <div className="live-campaign">
    ...
    <>
      ...
      <div className="live-campaign-gate"><ShieldWarning/><span><strong>Real execution, capability-gated</strong><small>RDKit, ADMET-AI and BRICS run locally. Vina ranking requires three stable seed replicates plus a same-pocket control. AiZynthFinder requires real policies and stock inputs. Missing capabilities finish as blocked, never simulated.</small></span></div>
